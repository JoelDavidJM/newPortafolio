...
const ProyectDos = ({language}) => {
  ...
  return (
    ...
    <div className='technologies__container__title'>
      ...
      <button className='technologies__btn' onClick={handelReset}>{language?.[0].PREV}</button>
    </div>
    ...
    <div className='technologies__prob'>
      <div className='technologies__prob1'>
        ...
        <span className='lorem'>{language?.[0].GITHUB}</span>
      </div>
<div className="section__div-div">
    ...
    <div className='technologies__prob1'>
        ...
        <span className='lorem'>{language?.[0].ANGULAR}</span>
      </div>
      <div className="section__div-div">
      <ul className="section__ul-container">
    ...
    <div className='technologies__prob1'>
        ...
        <span className='lorem'>{language?.[0].TYPESCRIPT}</span>
      </div>
<div className="section__div-div">
      <ul className="section__ul-container">
